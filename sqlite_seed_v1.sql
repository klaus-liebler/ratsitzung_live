...
INSERT OR IGNORE INTO users (
  ...
  (2, 'localhost', 'marie.vorsitz', 'marie.vorsitz@ratlive.local', 'Ratsmitglied', 'Marie', 'Vorsitz', '2026-01-01 08:00:00', NULL),
  (3, 'localhost', 'thomas.rat', 'thomas.rat@ratlive.local', 'Ratsmitglied', 'Thomas', 'Rat', '2026-01-01 08:00:00', NULL),
  (4, 'localhost', 'eva.expertin', 'eva.expertin@ratlive.local', 'Sachkundiger Buerger', 'Eva', 'Expertin', '2026-01-01 08:00:00', NULL),
  (5, 'localhost', 'paul.protokoll', 'paul.protokoll@ratlive.local', 'Protokollfuehrer', 'Paul', 'Protokoll', '2026-01-01 08:00:00', NULL),
  (6, 'localhost', 'ursula.useradmin', 'ursula.useradmin@ratlive.local', 'Verwaltung', 'Ursula', 'Useradmin', '2026-01-01 08:00:00', NULL);

-- Hinweis:
-- Passwort-Hashes sind Platzhalter und muessen in echten Umgebungen ersetzt werden.
-- V1-Startverhalten: Alle Seed-Accounts sind mit must_change_password=1 markiert.
INSERT OR IGNORE INTO users_localhost_credentials (
  ...
  (1, 'argon2id$demo$sysadmin_hash', 'argon2id', 1, '2026-01-01 08:00:00'),
  (2, 'argon2id$demo$chair_hash', 'argon2id', 1, '2026-01-01 08:00:00'),
  (3, 'argon2id$demo$council_hash', 'argon2id', 1, '2026-01-01 08:00:00'),
  (4, 'argon2id$demo$expert_hash', 'argon2id', 1, '2026-01-01 08:00:00'),
  (5, 'argon2id$demo$recorder_hash', 'argon2id', 1, '2026-01-01 08:00:00'),
  (6, 'argon2id$demo$useradmin_hash', 'argon2id', 1, '2026-01-01 08:00:00');
...
INSERT OR IGNORE INTO user_role_assignments (
  ...
  (10, 2, 5, 'COMMITTEE', 1, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (11, 2, 6, 'COMMITTEE', 1, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (12, 3, 6, 'COMMITTEE', 1, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (13, 4, 7, 'COMMITTEE', 1, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (14, 5, 8, 'COMMITTEE', 1, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (15, 3, 6, 'COMMITTEE', 2, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL),
  (16, 2, 5, 'COMMITTEE', 2, '2026-01-01 08:00:00', NULL, 1, '2026-01-01 08:00:00', NULL);
